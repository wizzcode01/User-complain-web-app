...
const AdminSlideBar = () => {
    ...
    const [open, setOpen] = useState(false)
      ...
      // define sidebar items with icons and links 
        const sidebarItems = [
            { icon: FaClipboardList, label: "Users Complaints", link: "/admin-dashboard/DashboardMain" },
            { icon: FaRegEdit, label: "Resolved Complaint", link: "/admin-dashboard/report-complaint" },
            { icon: FaChartLine, label: "Status", link: "/admin-dashboard/status" },
            { icon: FaClock, label: "Pending", link: "/admin-dashboard/pending" },
            { icon: FaTimesCircle, label: "Didn't Send", link: "/admin-dashboard/didnt-send" },
            { icon: FaBell, label: "Notifications", link: "/admin-dashboard/notifications" },
            { icon: FaCog, label: "Settings", link: "/admin-dashboard/settings" },
