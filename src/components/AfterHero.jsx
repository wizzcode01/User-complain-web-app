...
const AfterHero = ({ afterContent }) => {
    ...
    return (
        ...
        <div className="relative ">
            <img className="w-32 absolute mb-10 right-20 border-2 border-blue-600 rounded-full translate-x-0 rotate-45" src={img} alt="complain1" />
          <div className="flex p-10 gap-4 w-full lg:flex-row flex-col justify-center items-center "> 
