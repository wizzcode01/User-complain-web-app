  ...
  const cardData = [
    {
      ...
      content:
        "Ensure your voice is heard and prompt actions are taken to resolve issues. Reporting helps us track, respond, and improve the services we provide.",
      icon: <FaClipboardCheck />,
    },
    {
      title: "Improved Service Quality",
      content:
        "Every complaint is an opportunity for improvement. Your feedback helps us enhance processes and deliver better results for everyone.",
      icon: <FaChartLine />,
    },
    {
      title: "Safer & Better Environment",
      content:
        "By reporting concerns, you help create a safe, fair, and respectful environment for all. Together, we can prevent issues from recurring.",
      icon: <FaShieldAlt />,
    },
  ];
    ...
    <>
      <Layout>
        ...
        <Hero
          ...
          button={[
            { label: "Get Started", href: "/user-dashboard", type: "primary" },
      ...
      <AfterCardLayout>
        <AfterHero
          afterContent="Our platform makes it effortless for our customers to log in, file a complaint, and track its progress in real time.
